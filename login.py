...
class Login:
    def __init__(self, root):
        ...
        # ================= BACKGROUND =================
        bg = Image.open(r"C:\Users\madhu\OneDrive\Desktop\Face_Regonition _Attendance_System\college_images\back.jpg")
        ...
        self.btn_register = Button(self.frame, text="📝 Register", font=("Segoe UI", 12, "bold"), bg="#7b8ef0", fg="white",
                                activebackground="#6b9ce4", activeforeground="white", command=self.register_window)
        self.btn_register.pack(pady=10, ipadx=10, ipady=5)
        self.btn_register.bind("<Enter>", lambda e: self.btn_register.config(bg="#81aff0"))
        self.btn_register.bind("<Leave>", lambda e: self.btn_register.config(bg="#8bbff2"))
